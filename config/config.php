...
*/ 	
	define('SYSTEM_EMAIL', 'coscia@g.harvard.edu'); 

# Default DB name for this app
	define('DB_NAME', 'robcosci_p2_robcoscia_biz'); 
...
# Max number of posts returned
	define('MAX_POSTS_PER_PAGE', '40');